% 中英文摘要。摘要末尾参数为显示在摘要页的关键词。
\begin{cnabstract}{随机结构，马尔可夫过程，非线性构形状态，差分方法}
...
于简单结构的情况进行了解析求解，并据此探讨了结构非线性构形状态演化的若
干特征，发现了在实际应用中可能具有重要意义的稳定构形现象。讨论了力-状
态的解耦问题。基于非线性构形状态本身的性质以及演化过程的规律，初步研究
了可能的简化与近似方法
\end{cnabstract}

\begin{enabstract}{stochastic structure, Markov process, nonlinear configuration state,
difference method}
